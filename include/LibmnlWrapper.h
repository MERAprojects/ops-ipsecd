...
class LibmnlWrapper : public ILibmnlWrapper
{
    public:
         ...
         */
        struct mnl_socket* socket_open(int32_t bus);

        /**
         * @copydoc ILibmnlWrapper::socket_close
         */
        int32_t socket_close(struct mnl_socket* nl);

        /**
         * @copydoc ILibmnlWrapper::socket_bind
         */
        int32_t socket_bind(struct mnl_socket* nl, uint32_t groups, pid_t pid);

        /**
         * @copydoc ILibmnlWrapper::nlmsg_put_header
         */
        struct nlmsghdr* nlmsg_put_header(char* buf);

        /**
         * @copydoc ILibmnlWrapper::nlmsg_put_extra_header
         */
        void* nlmsg_put_extra_header(struct nlmsghdr* nlh, size_t size);

        /**
         * @copydoc ILibmnlWrapper::socket_get_portid
         */
        uint32_t socket_get_portid(const struct mnl_socket* nl);

        /**
         * @copydoc ILibmnlWrapper::socket_sendto
         */
        ssize_t socket_sendto(const struct mnl_socket* nl, const void* buf, size_t len);

        /**
         * @copydoc ILibmnlWrapper::socket_recvfrom
         */
        ssize_t socket_recvfrom(const struct mnl_socket* nl, void* buf, size_t bufsiz);

        /**
         * @copydoc ILibmnlWrapper::nlmsg_get_payload
         */
        void* nlmsg_get_payload(const struct nlmsghdr* nlh);
         ...
         */
        uint16_t attr_get_type(const struct nlattr* attr);

        /**
         * @copydoc ILibmnlWrapper::attr_type_valid
         */
        int32_t attr_type_valid(const struct nlattr* attr, uint16_t max);

        /**
         * @copydoc ILibmnlWrapper::attr_validate
         */
        int32_t attr_validate(const struct nlattr* attr, enum mnl_attr_data_type type);
         ...
         */
        int32_t attr_parse_nested(const struct nlattr* nested, mnl_attr_cb_t cb, void* data);
         ...
         */
        struct nlattr* attr_nest_start(struct nlmsghdr* nlh, uint16_t type);

        /**
         * @copydoc ILibmnlWrapper::attr_nest_end
         */
        void attr_nest_end(struct nlmsghdr* nlh, struct nlattr* start);

        /**
         * @copydoc ILibmnlWrapper::attr_get_u8
         */
        uint8_t attr_get_u8(const struct nlattr* attr);

        /**
         * @copydoc ILibmnlWrapper::attr_get_u16
         */
        uint16_t attr_get_u16(const struct nlattr* attr);
         ...
         */
        uint64_t attr_get_u64(const struct nlattr* attr);
         ...
         */
        void attr_put_u8(struct nlmsghdr* nlh, uint16_t type, uint8_t data);

        /**
         * @copydoc ILibmnlWrapper::attr_put_u16
         */
        void attr_put_u16(struct nlmsghdr* nlh, uint16_t type, uint16_t data);

        /**
         * @copydoc ILibmnlWrapper::attr_put_u32
         */
        void attr_put_u32(struct nlmsghdr* nlh, uint16_t type, uint32_t data);

        /**
         * @copydoc ILibmnlWrapper::attr_put_u64
         */
        void attr_put_u64(struct nlmsghdr* nlh, uint16_t type, uint64_t data);
};
